...
if os.path.exists("tessdata"):
    ...
    st.info("TESSDATA_PREFIX set to 'tessdata/' for custom language data.")
else:
    st.warning("Could not find the 'tessdata' folder. Myanmar language OCR may fail.")
...
def main():
    ...
    if image_array_bgr is not None:
        ...
        Built with Tesseract (eng+mya), OpenCV, Pandas, Streamlit, and PyMuPDF. 
        </div>
