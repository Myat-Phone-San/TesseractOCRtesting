...
def main():
    ...
    st.markdown("Upload a document (Image or PDF) to extract the **Applicant Name, Documentary Credit No., Original Credit Amount, Contact Person / Tel, and Beneficiary Name** using predefined regions.")
